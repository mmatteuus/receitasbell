...
export function PwaBottomNav({ tenantSlug }: PwaBottomNavProps) {
  ...
  return (
    ...
    >
      <div
        className="mx-auto flex h-full max-w-md items-center justify-around px-2"
      ...
      >
        {navItems.map((item) => (
          <NavLink
            ...
            className={({ isActive }) =>
              `flex min-h-14 min-w-14 flex-col items-center justify-center gap-1 rounded-lg transition-colors ${
