      ...
      <div className="flex min-h-screen flex-col items-center justify-center bg-background p-6">
        <Card className="w-full max-w-sm border-none shadow-none bg-transparent text-center">
          <CardHeader className="space-y-4">
            ...
            <CardDescription>Sua senha foi atualizada com sucesso. Você já pode acessar sua conta.</CardDescription>
          </CardHeader>
          <CardContent>
            <Button className="w-full h-12" onClick={() => navigate(buildPwaPath("home", { tenantSlug }))}>
              Ir para o App
            </Button>
          </CardContent>
        </Card>
