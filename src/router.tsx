...
function buildPaymentChildren() {
  return [
    { index: true, lazy: lazyRoute(() => import('@/pages/admin/payments/DashboardPage')) },
    {
      path: 'transacoes',
      lazy: lazyRoute(() => import('@/pages/admin/payments/TransactionsPage')),
    },
    {
      path: 'transacoes/:id',
...
function buildAdminChildren() {
  return [
    ...
    {
      path: 'categorias',
      lazy: lazyRoute(() => import('@/pages/admin/categories/CategoriesPage')),
    },
    { path: 'pagamentos', children: buildPaymentChildren() },
    { path: 'financeiro', children: buildPaymentChildren() },
    { path: 'configuracoes', lazy: lazyRoute(() => import('@/pages/admin/SettingsPage')) },
    {
      path: 'configuracoes/pagina-inicial',
      lazy: lazyRoute(() => import('@/pages/admin/HomePageSettings')),
    },
