...
export const DEFAULT_CATEGORIES: Category[] = [
  {
    ...
    name: 'Salgadas',
    slug: 'salgadas',
    description: 'Receitas salgadas para qualquer ocasião',
  ...
  },
  {
    ...
    name: 'Massas',
    slug: 'massas',
    description: 'Massas caseiras e molhos especiais',
    createdAt: DEFAULT_CATEGORY_TIMESTAMP,
  },
  {
    id: 'cat-doces',
    name: 'Doces',
    slug: 'doces',
    description: 'Sobremesas e doces irresistíveis',
    createdAt: DEFAULT_CATEGORY_TIMESTAMP,
  },
  {
    id: 'cat-bolos',
    name: 'Bolos',
    slug: 'bolos',
    description: 'Bolos para todas as celebrações',
    createdAt: DEFAULT_CATEGORY_TIMESTAMP,
  },
  {
    id: 'cat-bebidas',
  ...
  },
  {
    ...
    name: 'Saudáveis',
    slug: 'saudaveis',
    description: 'Receitas leves e nutritivas',
    createdAt: DEFAULT_CATEGORY_TIMESTAMP,
  },
];
...
export const DEFAULT_SITE_SETTINGS: SiteSettings = {
  ...
  siteDescription:
    'Receitas testadas e aprovadas para tornar seus momentos na cozinha inesquecíveis.',
...
export const DEFAULT_HOME_SETTINGS: HomeSettings = {
  heroBadge: 'Novas receitas toda semana',
  ...
  featuredSectionTitle: 'Receitas em destaque',
  featuredSectionSubtitle: 'As melhores receitas selecionadas para você.',
  ...
  trustBarItems: [
    ...
    'Novas receitas e coleções toda semana',
  ],
