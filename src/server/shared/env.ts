...
const schema = z.object({
  ...
  // Baserow (legacy and operational modules)
  ...
  BASEROW_TABLE_SESSIONS: z.string().optional(),
  BASEROW_TABLE_MAGIC_LINKS: z.string().optional(),
  BASEROW_TABLE_AUTH_OAUTH_STATES: z.string().optional(),
  BASEROW_TABLE_USER_IDENTITIES: z.string().optional(),
