...
1. **FRONT-005** → Consolidar plano SEO final (componentização de `PageHead`, validação de OG tags por rota, sitemap).
2. **FRONT-006** → Criar dossiê com métricas de adesão PWA + melhorias de UX (cards, toasts, instruções iOS/Android).
