...
| FRONT-005 | SEO + Meta tags finais (App + PWA)                | P3         | ✅ CONCLUÍDO   | 2026-04-07         | `FRONT-005-seo.md` + PageHead em rotas privadas e admin             |
| FRONT-006 | Checklist de experiência PWA (instalação/offline) | P2         | ⏳ EM EXECUÇÃO | 2026-04-07         | `FRONT-006-pwa.md` + hook `usePwaState` + CTA restrito ao `/pwa/**` |
...
1. **Aguardando nova prioridade front-end**.

---

_Arquivo mantido por OpenCode — Atualizado: 2026-04-07 11:45 (BRT)._
