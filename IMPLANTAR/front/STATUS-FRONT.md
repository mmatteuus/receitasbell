...
| FRONT-006 | Checklist de experiência PWA (instalação/offline) | P2         | 🟡 EM PLANEJAMENTO | 2026-04-07         | `FRONT-006-pwa.md` + Plano de ação (3 fases)                    |
...
1. **FRONT-006** → Criar dossiê com métricas de adesão PWA + melhorias de UX (cards, toasts, instruções iOS/Android).
